...
python paprica_place_it_v0.20.py combined_16S.tax &&

## 3. run test.fasta 

python paprica_place_it_v0.20.py test combined_16S.tax &&
...
python paprica_build_core_genomes_v0.20.py test.combined_16S.tax.clean.align.phyloxml &&
