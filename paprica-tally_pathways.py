...
genome_data = pd.DataFrame.read_csv(ref_dir_domain + 'genome_data.final.csv', header = 0, index_col = 0)
internal_data = pd.DataFrame.read_csv(ref_dir_domain + 'internal_data.csv', header = 0, index_col = 0)

terminal_paths = pd.DataFrame.read_csv(ref_dir_domain + 'terminal_paths.csv', header = 0, index_col = 0)
internal_probs = pd.DataFrame.read_csv(ref_dir_domain + 'internal_probs.csv', header = 0, index_col = 0)

internal_ec_probs = pd.DataFrame.read_csv(ref_dir_domain + 'internal_ec_probs.csv', header = 0, index_col = 0)
internal_ec_n = pd.DataFrame.read_csv(ref_dir_domain + 'internal_ec_n.csv', header = 0, index_col = 0)
terminal_ec = pd.DataFrame.read_csv(ref_dir_domain + 'terminal_ec.csv', header = 0, index_col = 0)
...
query_csv = pd.DataFrame.read_csv(cwd + query, header = 0)
...
if unique != False:
    ...
    unique_csv = pd.DataFrame.read_csv(cwd + unique, header = 0, index_col = 0)
