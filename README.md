...
![Metabolic pathways in bacterial genomes in current paprica database](https://github.com/bowmanjeffs/paprica/blob/master/bacteria_terminal_path_distribution.png, heigth=100, align='left')
